...
const char * field_states_names[] = {"empty", "plowed", "planted"};
const char * barn_states_names[] = {"empty", "animal", "full"};

const char * plant_phase_name[] = {"Seedling", "Growing", "Flowers", "Fruits"};
const char * class_name[] = {"unknown", "BaseElement", "BaseAnimal", "BasePlant", "Element", "Ingredient", "Product", "Scroll", "Field", "Barn", "Plant", "Animal", "Player", "Npc", "Clan",
    "ListElement", "KnownElement", "BaseListElement"};
